...
{
	/* TCP ACE flags of SYN/ACK or pure ACK are set based on IP-ECN
	 * codepoint received from SYN or SYN/ACK respectively. Below is
	 * an excerpt from Tables 2 and 3 of the AccECN spec:
	 * +====================+====================================+
	 * |  IP-ECN codepoint  | Respective SYN/ACK of received SYN |
	 * |   received on SYN  |   or pure ACK of received SYN/ACK  |
	 * |    or SYN/ACK      |       AE       CWR       ECE       |
	 * +====================+====================================+
	 * |      Not-ECT       |       0         1         0        |
	 * |      ECT(1)        |       0         1         1        |
	 * |      ECT(0)        |       1         0         0        |
